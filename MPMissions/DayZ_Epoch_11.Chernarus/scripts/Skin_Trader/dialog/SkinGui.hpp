...
class MenClothing {
	...
	onLoad = "[] execVM 'scripts\Skin_Trader\List_Men.sqf'";
	...
	class controls {
		...
		class RecruitButton: HW_RscGUIShortcutButton {
			...
			w = 0.125; h = 0.05;
			text = "Buy Skin";
			onButtonClick = "execVM 'scripts\Skin_Trader\GetMen.sqf'";
		};
...
class WomanClothing {
	...
	movingEnable = true;
	enableSimulation = true;
	onLoad = "[] execVM 'scripts\Skin_Trader\List_Woman.sqf'";
	...
	class controls {
		...
		class RecruitButton: HW_RscGUIShortcutButton {
			...
			w = 0.125; h = 0.05;
			text = "Buy Skin";
			onButtonClick = "execVM 'scripts\Skin_Trader\GetWoman.sqf'";
		};
		class CloseButton: RecruitButton {
			x = 0.15;
			text = "Close";
